...
public class EmployeeService {
    ...
    public List<Employee> searchEmployeesByNameAndAge(int age, String name){
        return employeeRepo.findByNameAndAge(name, age);
//        return customEmployeeRepo.findByNameAndAge(name, age);
//        return customEmployeeRepo.searchByNameAndAge(age, name);
    }
...
//        return customEmployeeRepo.searchByName(name);
  ...
  public List<Employee> searchEmployeesByName2(String name){
